...
const AboutUs = () => (
  <div className="container">
    ...
    <p> SODP believes that the promise of open data on college campuses extends beyond the 94305 zip code. We are proud to have helped budding open data portals at other universities and recently joined forces with the Northwestern Open Data Initiative to publish <i><a href="https://opendatacampus.com/" target="_blank" rel="noopener noreferrer">The Open Data Handbook for College Students</a></i>. This extensive guide compiles our learnings and best practices to help students across the country open up data at their own universities. The document also includes a provisional discussion and flowchart about data governance, which codifies SODP’s current approach to data governance. SODP is acutely aware of the dangers of open data including but not limited to breaches of privacy and unrepresentative datasets. In addition, we understand that any Stanford-related data is inextricably tangled with unjust distributions of power at Stanford. We are actively working to ensure that SODP supports student advocates who are fighting issues like racism, sexism, and classism on campus and beyond.</p>
