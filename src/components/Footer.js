...
function Footer() {
    return (
      <div className="footer">
        Interested in creating your own data portal? Check out our <a href="https://github.com/UCOpenData/open-data-portal" target="_blank" rel="noopener noreferrer"> GitHub</a>!
        <br></br>
